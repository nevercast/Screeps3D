...
////{
////    /// <summary>
////    /// A <see cref="SettingsProvider"/> implementation that creates an interface from settings reflected
...
////                {
////                    if (!EditorUtility.DisplayDialog("Reset All Settings", "Reset all settings? This is not undo-able.", "Reset", "Cancel"))
////                        return;
